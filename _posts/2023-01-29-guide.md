...
_Note: In a real scenario we would like to have the PSC (preferred scanning channels) available. These are the channels that client will actively scan to disover the SSID _
