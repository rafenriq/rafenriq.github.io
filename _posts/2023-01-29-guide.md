...
_- Device entitled with DNA Esentials will receive a Meraki Enterprise Level License_
...
Note that in order to claim the Access Points, you must have the appropriate licenses, such as co-termination or per-device licensing models. On the reference section we leave the links to understand the licenses model. 
